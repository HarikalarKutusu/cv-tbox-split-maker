...
def main() -> None:
    ...
    print(
        f"Re-splitting for {g.SRC_COUNT} out of {g.TOTAL_COUNT} corpora in {PROC_COUNT} processes."
    )
    ...
    print(
        f"Dataset Sizes - TINY: {g.TINY_DATASET_COUNT} MEDIUM: {g.MEDIUM_DATASET_COUNT} LARGE: {g.LARGE_DATASET_COUNT}"
    )
    print(
